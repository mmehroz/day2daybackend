...
const {{asset('public/assets: React.FC<MenuProps> = ({ data, className }) => {
	const { t } = useTranslation("menu");
	return (
		<nav className={classNames(`{{asset('public/assets flex w-full relative`, className)}>
			{data?.map((item: any) => (
				<div
...
export default {{asset('public/assets;}}
