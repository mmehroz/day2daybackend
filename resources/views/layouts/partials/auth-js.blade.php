...
<script src="{!! url('public/assets/js/material-dashboard.js?v=2.1.2') !!}" type="text/javascript"></script>
...
<script>
 ...
 function myFunction() {
   ...
   var headingColor = document.getElementsByClassName("card");
   for(var i=0; i<headingColor.length; i++) { 
    headingColor[i].classList.toggle("background-dark");
}
}
