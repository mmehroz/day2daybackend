@extends('layouts.app-master', ['activePage' => 'product',  'activeSub'=> 'product',   'titlePage' => __('All Products')])
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <a href="{{ route('products.create') }}" class="btn btn-primary col-md-3 ml-auto">Create New Product</a>
                    <!-- /.box-header -->
                    <div class="card-body">
