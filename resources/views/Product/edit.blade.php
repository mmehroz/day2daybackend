                    ...
                    <div class="card-body">
                        <form action="{{ route('products.update', $product) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            value="{{ old('product_sku', $product->product_sku) }}"> <div class="help-block"></div>
                                        </div>
                                        @error('product_sku')
                                            <span class="alert text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h5>Additional Info <span class="text-danger"></span></h5>
                                        <div class="controls">
                                            <textarea name="additional_info" id="editor3" cols="30" rows="5" class="form-control">
                                                {{ old('additional_info', $product->additional_info) }}
                                            </textarea>
                                             <script>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            ...
                                            onChange="mainThumbnailShow(this)" style="position: static !important; opacity: 1 !important"> <div class="help-block"></div>
                                        </div>
                                        @error('product_thumbnail')
                                            <span class="alert text-danger">{{ $message }}</span>
                                        @enderror
                                        <img src="{{ asset('public/assets/img/products/thumb/') }}{{$product->product_thumbnail}}" id="mainThumbnail" alt="">
                                    </div>
                                </div>
                            </div>
                            {{-- Seventh row end --}}
