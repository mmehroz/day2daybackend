@extends('layouts.app-master', ['activePage' => 'product',  'activeSub'=> 'sub_cat',   'titlePage' => __('Create Sub Category')])
                    ...
                    <div class="card-body">
                        <form action="{{ route('sub_category.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="subcategory_name" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                </div>
